...
def _load_CR_rpf(poly_order):
    twoD_CRonly = TwoDAlphabet('XHY_CRlp','AN_loosetopass.json', loadPrevious=True)
...
def test_make():
    twoD = TwoDAlphabet('XHY_CRlp','AN_loosetopass.json',loadPrevious=False)
    qcd_hists = twoD.InitQCDHists()

    # this loop only runs once, since the only regions are CR_fail, CR_loose, CR_pass
    for f,l in [_get_other_region_names(r) for r in twoD.ledger.GetRegions() if 'Loose' in r]:
	...
	qcd_rpf = ParametricFunction(
                fail_name.replace('Loose','rpf')+'_'+opt_name,
                binning_f, opt['form'],
                constraints=opt['constraints']

        )
        qcd_l = qcd_f.Multiply(fail_name.replace('Loose','Pass')+'_'+opt_name,qcd_rpf)
        twoD.AddAlphaObj('Background'+'_'+opt_name,l,qcd_l,title='Multijet')

    twoD.Save()

def test_fit(signal, tf='', defMinStrat=0,  extra='--robustFit 1'): #extra='--robustHesse 1'
    working_area = 'XHY_CRlp'
    ...
    twoD.MLfit('{}-{}_area'.format(signal,tf),rMin=-5,rMax=20,verbosity=2,extra=extra)
    print('im here')
    print('im here')
...
if __name__ == "__main__":
    ...
    #test_fit('MX3000_MY300', tf='0x0', defMinStrat=0, extra='--robustFit 1')
    #test_fit('MX3000_MY300', tf='0x1', defMinStrat=0, extra='--robustFit 1')
    #test_fit('MX3000_MY300', tf='1x0', defMinStrat=0, extra='--robustFit 1')
    #test_fit('MX3000_MY300', tf='1x1', defMinStrat=0, extra='--robustFit 1')
    #test_fit('MX3000_MY300', tf='2x0', defMinStrat=0, extra='--robustFit 1')
    #test_fit('MX3000_MY300', tf='2x1', defMinStrat=0, extra='--robustFit 1')
    #test_fit('MX3000_MY300', tf='2x2', defMinStrat=0, extra='--robustFit 1')
    #test_fit('MX3000_MY300', tf='3x2', defMinStrat=0, extra='--robustFit 1')
    
    
    #test_plot('MX3000_MY300', tf='0x0')
    #test_plot('MX3000_MY300', tf='0x1')
    #test_plot('MX3000_MY300', tf='1x0')
    #test_plot('MX3000_MY300', tf='1x1')
    #test_plot('MX3000_MY300', tf='2x0')
    #test_plot('MX3000_MY300', tf='2x1')
    #test_plot('MX3000_MY300', tf='2x2')
    #test_plot('MX3000_MY300', tf='3x2')
    

    
    opt_names = ['2x0','2x1','2x2','3x2']
    #opt_names = ['0x0','0x1','1x0','1x1','2x0','2x1','2x2','3x2']
    for opt_name in opt_names:
        test_GoF('MX3000_MY300',tf=opt_name,condor=False)
        test_GoF_plot('MX3000_MY300', tf=opt_name, condor=False)
    

    
    #test_FTest('0x0','1x0',signal='MX3000_MY300')
    #test_FTest('1x0','0x1',signal='MX3000_MY300')
    #test_FTest('1x0','1x1',signal='MX3000_MY300')
    #test_FTest('1x0','2x0',signal='MX3000_MY300')
    #test_FTest('1x0','2x1',signal='MX3000_MY300')
    #test_FTest('1x0','2x2',signal='MX3000_MY300')
    #test_FTest('1x0','3x2',signal='MX3000_MY300')
