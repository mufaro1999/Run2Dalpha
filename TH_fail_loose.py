...
def test_make():
    twoD = TwoDAlphabet('XHY_CRfl','AN_failtoloose.json',loadPrevious=False)
...
def test_fit(signal, tf='', defMinStrat=0,  extra='--robustFit 1'): #extra='--robustHesse 1'
    ...
    twoD.MLfit('{}-{}_area'.format(signal,tf),rMin=1,rMax=5,verbosity=2,extra=extra)
...
if __name__ == "__main__":
    ...
    opt_names = ['0x1','1x0','1x1','2x0','2x1','2x2','3x2']
    #opt_names = ['0x0','0x1','1x0','1x1','2x0','2x2','3x2']
    
    #opt_names = ['2x1','2x2','3x2'] 
    for opt_name in opt_names:
        test_GoF('MX3000_MY300',tf=opt_name,condor=False)
        test_GoF_plot('MX3000_MY300', tf=opt_name, condor=False)
    
    #test_FTest('0x0','1x1',signal='MX3000_MY300')
    test_FTest('1x0','1x1',signal='MX3000_MY300')
    test_FTest('0x1','1x1',signal='MX3000_MY300')
    
    test_FTest('1x1','2x1',signal='MX3000_MY300')
    test_FTest('1x1','2x0',signal='MX3000_MY300')
    test_FTest('2x1','2x2',signal='MX3000_MY300')
    test_FTest('2x1','3x2',signal='MX3000_MY300')
    
    
    test_fit('MX3000_MY300', tf='3x2', defMinStrat=0, extra='--robustFit 1')
    #test_GoF('MX3000_MY300',tf='3x2',condor=False)
    #test_GoF_plot('MX3000_MY300', tf='3x2', condor=False)
    #test_plot('MX3000_MY300', tf='2x1')